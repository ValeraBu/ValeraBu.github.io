...
var effectsEffectTransfer = effect;
   ...
   jQuery(document).ready(function($) {
	...
	$('.recommendation-catalog-inner').slick({
	  infinite: true,
	  slidesToShow: 4,
	  slidesToScroll: 1,
	  dots: true,
	...
	$('.button').click(function (event) {
		...
		$(this).closest('.recommendation-title').siblings('.select-products_list').toggleClass('active');
		$(this).children('.icon-arrow').toggleClass('rotate');
	});

	$('.button').click(function (event) {
		$(this).toggleClass('active');
		$(this).closest('.select-title').siblings('.select-products_list').toggleClass('active');
		$(this).children('.icon-arrow').toggleClass('active');
	});

	$('.button').click(function (event) {
		$(this).toggleClass('active');
		$(this).closest('.main-page__title').siblings('.select-products_list').toggleClass('active');
		$(this).children('.icon-arrow').toggleClass('active');
	});

	$('.select-price-title').click(function (event) {
        $(this).parent('.dropdown').find('.select-price_list').toggleClass('active');
...
// faq-page
	$('.question').click(function (event) {
      ...
      $(this).parent('.questions-inner').siblings().find('.question.clicked').toggleClass('clicked');
	...
	$('.gallery-card_item').on('click', function(event) {
		event.preventDefault();
		/* Act on the event */
		var img = $(this).attr('href');
		var bigImg = $(this).attr('data-image');
		// $('.fancybox-button').attr('href', data-image);
		$('.fancybox-button').prop('href', bigImg);
		// $('.fancybox-button').children('img').attr('src', img);
		$('.fancybox-button').children('img').prop('src', img);
	});
...
// footer mobile-menu
	$('.footer-button').on('click', function(event) {
		event.preventDefault();
		$('.main-footer__top').addClass('open');
	});
	$('.close-menu').on('click', function(event) {
		event.preventDefault();
		$('.main-footer__top').removeClass('open');
	});

//catalog mobile-menu
	$('.catalog-filter').on('click', function(event) {
		event.preventDefault();
	...
	$('.text-open').click(function (event){
		$(this).parent('.text-toggle').find('.catalog-page_about').toggleClass('open');
		$(this).toggleClass('clicked').text('Свернуть');
		if($('.text-open').hasClass('clicked')) {
			$(this).text('Свернуть');
		}
		else
		{
	...
	$('.description-open').click(function (event){
		$(this).parent('.description-toggle').find('.good-card_main-about').toggleClass('open');
		$(this).toggleClass('clicked').text('Свернуть');
		if($('.description-open').hasClass('clicked')) {
			$(this).text('Свернуть');
		}
		else
		{
	...
	$('.footer-menu_inner').click(function (event){
		$(this).parent('.col-list').removeClass('open');
	});

	$('.btn-search_footer').click(function (event){
		$(this).parent('.form_search_footer').addClass('active');
		setTimeout(function() {
		$('.btn-search_footer').attr('type','submit');
	 }, 300 );
	});
});

	$(document).mouseup(function (e) {
   var form = $(".form_search_footer");
   if (form.has(e.target).length === 0){
     $(".form_search_footer").removeClass('active');
		 $('.btn-search_footer').attr('type','button');
   }
 });
 // modals
jQuery(document).ready(function($) {
	 ...
	 $('.button-phone').on('click', function(event) {
	 	event.preventDefault();
	 	$('.modal-phone').addClass('open');
	 });
	 $('.close-menu').on('click', function(event) {
	 	event.preventDefault();
	 	$('.modal-phone').removeClass('open');
	 });
	 ...
	 $('.call-me_btn').on('click', function(event) {
	 	event.preventDefault();
	 ...
	 $('.products-modal_btn').on('click', function(event) {
	 	event.preventDefault();
	 	$('.products-modal').addClass('open');
	 });
	 $('.close-menu').on('click', function(event) {
	 	event.preventDefault();
	 	$('.products-modal').removeClass('open');
	 });
	 $('.products-modal_btn-next').on('click', function(event) {
	 	event.preventDefault();
	 	$('.products-modal').removeClass('open');
	 });

	 $('.write-us_btn').on('click', function(event) {
	 	event.preventDefault();
	 	$('.write-us-modal').addClass('open');
	 });
	 $('.close-menu').on('click', function(event) {
	 	event.preventDefault();
	 	$('.write-us-modal').removeClass('open');
	 });
...
function initInternationalClocks() {
  ...
  var elements = document.querySelectorAll('.flash-clock');
